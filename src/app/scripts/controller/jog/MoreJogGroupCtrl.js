var MoreJogGroupCtrl = ['$rootScope', '$scope', '$location', 'getRecommendGroupsService', 'getGroupListService',
    function ($rootScope, $scope, $location, getRecommendGroupsService, getGroupListService) {
        ...
        $scope.searchClick = function () {
            ...
            _getGroupListFn(function(){
                if(flag){
                	$scope.form.searchBackPath = '/moreJogGroup';
        ...
        $scope.selectClick = function (groupId) {
            ...
            $scope.form.detailsBackPath = '/moreJogGroup';
